...
namespace BooleanWidth.Algorithms.BooleanWidth.Linear
{
    public static class LinearMaximumIs
    {
        ...
        class LookupTable : IEnumerable
        {
            ...
            private Dictionary<BitSet, Isn> _data;

            public LookupTable()
            {
                _data = new Dictionary<BitSet, Isn>();
            }
            ...
            public void Update(Isn iset)
            {
                ...
                if (_data.ContainsKey(iset.Elements))
                {
                    ...
                    if (iset.Size > _data[iset.Elements].Size)
                        _data[iset.Elements] = iset;
                }
                else
                {
                    _data[iset.Elements] = iset;
